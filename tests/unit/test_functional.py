...
class TestFunctional:
    ...
    def test_provision_standalone_instance(
        ...
        mock_provisioner_instance.cli.return_value = mongod
    ...
    def test_provision_replica_set(
        ...
        mock_provisioner_instance = provisioner_patch.return_value
        mock_provisioner_instance.cli.return_value = replica_set
    ...
    def test_provision_sharded_cluster(
        ...
        mock_provisioner_instance = provisioner_patch.return_value
        mock_provisioner_instance.cli.return_value = sharded_cluster
